Feature: Smoke for Registration using Aadhaar Card
...
@TestCaseKey=UDB-T1295
@TestCaseKey=UDB-T1296
Scenario Outline: Verify to generate aadhaar OTP using generateaadharotp API
Given user sets the environment of endpoint
Given user set the basepath to <service>
Then set the endpoint <endpoint>
Then user triggers a post request with <requestBody>
...
Examples:
|service     |endpoint           |requestBody                                                                 |responseBody|
|registration|/generateaadharotp |\src\test\resources\testdata\api\request\mvp\registration\generateaadharotp.json |\src\test\resources\testdata\api\response\expected\mvp\registration\generateaadharotp.json|

@TestCaseKey=UDB-T1302
@TestCaseKey=UDB-T1303
Scenario Outline: Verify to verify aadhaar OTP using verifyaadharotp API
...
Examples:
|service     |endpoint         |requestBody                                                                 |responseBody|
|registration|/verifyaadharotp |\src\test\resources\testdata\api\request\mvp\registration\verifyaadharotp.json |\src\test\resources\testdata\api\response\expected\mvp\registration\verifyaadharotp.json|
