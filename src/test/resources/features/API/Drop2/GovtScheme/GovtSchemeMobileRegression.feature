...
@TestCaseKey=UDB-T15009
  Scenario Outline: Verify showPMGovtSchmDetails API returns 404 response for invalid endpoint
    ...
    Examples:
      ...
      | govt_scheme_mobile | /showPMGovtSchmDetails/ | /src/test/resources/testdata/api/request/Drop2/govtscheme/mobile/showPMGovtSchmDetails.json | null | null | null | src/test/resources/testdata/api/response/expected/Drop2/govtscheme/mobile/GS_showPMGovtSchmDetails_Response_404.json |
...
Scenario Outline: Verify that API is not allowing user to showPMGovtSchmDetails without schemeCode gives 400 api response
      Given user sets the environment of endpoint
      Given user set the basepath to <service>
      Then set the endpoint <endpoint>
      Then user triggers a post request with <requestBody>
...
Scenario Outline: Verify that API is not allowing user to showPMGovtSchmDetails without channelId gives 400 api response
      Given user sets the environment of endpoint
      Given user set the basepath to <service>
      Then set the endpoint <endpoint>
      Then user triggers a post request with <requestBody>
...
Scenario Outline: Verify that API doesn't allow user to showPMGovtSchmDetails with invalid cif gives 401 api response
      Given user sets the environment of endpoint
      Given user set the basepath to <service>
      Then set the endpoint <endpoint>
      Then user triggers a post request with <requestBody>
...
Scenario Outline: Verify that API doesn't allow user to showPMGovtSchmDetails with invalid schemeCode gives 400 api response
      Given user sets the environment of endpoint
      Given user set the basepath to <service>
      Then set the endpoint <endpoint>
      Then user triggers a post request with <requestBody>
...
Scenario Outline: Verify that API doesn't allow user to showPMGovtSchmDetails with invalid channelId gives 400 api response
      Given user sets the environment of endpoint
      Given user set the basepath to <service>
      Then set the endpoint <endpoint>
      Then user triggers a post request with <requestBody>
...
Scenario Outline: Verify that API is not allowing to use existing account/cif gives 400 api response
      Given user sets the environment of endpoint
      Given user set the basepath to <service>
      Then set the endpoint <endpoint>
      Then user triggers a post request with <requestBody>
...
#      Then user triggers a post request with <requestBody>
#      Then user verifies that status is 400
#      Then user verifies json from <responseBody>3      Examples:
#     | service        | endpoint         | requestBody   | responseBody                    |
...
Scenario Outline:Verify savePMGovtSchmDetails API returns 200 response with all channel id's
    ...
    Examples:
      | service            | endpoint               | requestBody																																								  | responseBody |
      | govt_scheme_mobile | /savePMGovtSchmDetails | \src\test\resources\testdata\api\request\Drop2\govtscheme\mobile\savePMGovtSchmDetails_withAllChannelId2.json | \src\test\resources\testdata\api\response\expected\Drop2\govtscheme\mobile\savePMGovtSchmDetails_withAllChannelId2.json |
...
@TestCaseKey=UDB-T14990
  Scenario Outline: Verify retrieveEnrollmentDetails API returns 404 response for invalid endpoint
    ...
    Examples:
      | service            | endpoint                | requestBody 																																						      |requestField   |responsefield      | filename       | responseBody                    |
      | govt_scheme_mobile | /retrieveEnrollmentDetails/ | \src\test\resources\testdata\api\request\Drop2\govtscheme\mobile\retrieveEnrollmentDetails.json | null | null | null | src\test\resources\testdata\api\response\expected\Drop2\govtscheme\mobile\GS_retrieveEnrollmentDetails_Response_InvalidEndpoint.json |
...
# Edge getPMSchemeDetails
  ...
  Scenario Outline: Verify "/getPMSchemeDetails" API "POST" Method for Status code 400 with Mandatory tags are invalid in request body
   ...
   @TestCaseKey=UDB-	 @Regression
  Scenario Outline: Verify "/getPMSchemeDetails" API "POST" Method for Status code 401 if Request body is blank
    Given user sets the environment of endpoint
    Given user set the basepath to <service>
    Then set the endpoint <endpoint> 
    Then user triggers a post request with <requestBody>
...
@TestCaseKey=UDB-T15053
 ...
 Given user sets the environment of endpoint
    ...
    Examples:
      | service            | endpoint                | requestBody 																																						      |requestField   |responsefield      | filename       | responseBody                    |
      | govt_scheme_mobile | /downloadCOI/ | \src\test\resources\testdata\api\request\Drop2\govtscheme\mobile\downloadCOI.json | null | null | null | src\test\resources\testdata\api\response\expected\Drop2\govtscheme\mobile\GS_downloadCOI_Response_Regression_InvalidEndpoint.json |
