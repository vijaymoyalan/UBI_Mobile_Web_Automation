    ...
    private static int searchTestCycle(String cookie, String testCycleKey){
        try {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                fetchUniqueIdToChangeStatus(cookie, keyIdMap.get(testCycleKey));
...
//                return keyIdMap.get(testCycleKey);
    ...
    private static void fetchUniqueIdToChangeStatus(String cookie, int testCycleId) {
...
//            System.out.println("Response Content: " + content);
            ...
            for (int i = 0; i < testRunItems.length(); i++) {
                ...
                updateTestResult(cookie, lastTestResult.getInt("id"), statusIds.get("Pass"));
