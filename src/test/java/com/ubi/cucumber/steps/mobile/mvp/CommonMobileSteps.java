...
//	added by Vijay M on 14/7/2025
	...
	// added by Vijay M for MSME APP (here 6 character system generated text is entered)
	@When("^user is on page (.+) to enter auto generated text on (.+)$")
	public void user_entersAutoGeneratedText(String pageName, String elementName) {
		common.waitTillElementDisplayed(pageName,elementName);
		String randomStr = randomStringUtil.generateRandomString(6);
		common.enterText(pageName,elementName,randomStr);
		common.keyboardNext();
	}
	
	//added by Sachin
	@Given("^user clicks back button on mobile$")
	public void pressBackButton() {
		common.pressBackbuttonOnMobile();
	}
	
//	added by Vijay M on 10/9/2025
	@Given("^user logins to MSME app entering Incorrect Login PIN$")
	public void enterIncorrectMPIN() throws InterruptedException {
		
		common.waitTillElementDisplayed(mfaPage.MSMELoginPin1);
		common.clickObject(mfaPage.MSMELoginPin1);
		common.enterText(mfaPage.MSMELoginPin1, "1");
		common.enterText(mfaPage.MSMELoginPin2, "1");
		common.enterText(mfaPage.MSMELoginPin3, "1");
		common.enterText(mfaPage.MSMELoginPin4, "1");
